  ...
  try {
    const anthropicRes = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 4000,
        system: `You are a senior macro strategist and market analyst at a tier-1 wealth management firm. Today is ${today}. You write sharp, concise, high-quality morning market briefings for a professional sales desk covering structured products, FX, fixed income and equity for HNW clients. Your tone is authoritative, direct and precise — like a Bloomberg Intelligence brief. ${langNote}`,
        tools: [{ type: 'web_search_20250305', name: 'web_search' }],
        messages: [{
          role: 'user',
          content: `Search for today's key financial market developments and generate a morning briefing. ${focusNote}

Search for: overnight equity moves, FX rates and moves, bond yield levels, commodity prices, central bank news, macro data releases, geopolitical developments affecting markets.

Return ONLY a raw JSON object — no markdown, no prose, no code fences:
{
  "headline": "one punchy headline capturing today's dominant market theme (max 12 words)",
  "standfirst": "2-3 sentence summary of the key macro narrative for today",
  "sentiment": "RISK-ON or RISK-OFF or NEUTRAL",
  "tickers": [
    {"name": "S&P 500", "value": "5,234", "change": "+0.4%", "direction": "up"},
    {"name": "EUR/USD", "value": "1.0823", "change": "-0.2%", "direction": "down"},
    {"name": "US 10Y", "value": "4.32%", "change": "+3bp", "direction": "up"},
    {"name": "GOLD", "value": "$2,312", "change": "+0.8%", "direction": "up"},
    {"name": "BRENT", "value": "$84.2", "change": "-1.1%", "direction": "down"},
    {"name": "USD/JPY", "value": "153.4", "change": "+0.3%", "direction": "up"}
  ],
  "sections": [
    {
      "title": "FX",
      "content": "3-4 sentences covering key FX moves, drivers, levels to watch. Reference specific rates and moves.",
      "fullWidth": false
    },
    {
      "title": "RATES",
      "content": "3-4 sentences on yield curve dynamics, central bank outlook, key bond market moves.",
      "fullWidth": false
    },
    {
      "title": "EQUITY",
      "content": "3-4 sentences on equity market performance, sector rotation, key indices and drivers.",
      "fullWidth": false
    },
    {
      "title": "COMMODITIES",
      "content": "3-4 sentences on oil, gold, metals, agricultural — key moves and drivers.",
      "fullWidth": false
    },
    {
      "title": "MACRO",
      "content": "3-4 sentences on macro data, central bank policy, geopolitical factors and their market implications.",
      "fullWidth": false
    },
    {
      "title": "STRUCTURED PRODUCTS",
      "content": "2-3 sentences on what today's vol environment, rates and equity levels mean for structured product ideas — DCDs, barrier notes, autocallables, CLNs.",
      "fullWidth": false
    }
  ],
  "tradeIdeas": [
    {
      "direction": "LONG",
      "title": "Brief trade idea title",
      "rationale": "1-2 sentence rationale grounded in today's market context"
    },
    {
      "direction": "SHORT",
      "title": "Brief trade idea title",
  ...
  "events": [
    {"time": "08:30 ET", "name": "US Non-Farm Payrolls", "importance": "HIGH"},
    {"time": "12:00 ET", "name": "ECB Lagarde Speech", "importance": "MEDIUM"},
    {"time": "14:00 ET", "name": "US ISM Services PMI", "importance": "MEDIUM"}
  ]
}`
        }]
      })
...
/* TRADE IDEAS */
.trade-card{border:1px solid #000;padding:1rem 1.25rem;margin-bottom:0.75rem;position:relative}
.trade-card:last-child{margin-bottom:0}
.trade-card.last{border-bottom:none}
.trade-direction{font-family:'JetBrains Mono',monospace;font-size:0.58rem;letter-spacing:0.12em;text-transform:uppercase;padding:0.2rem 0.55rem;border:1px solid #000;display:inline-block;margin-bottom:0.5rem}
.trade-direction.long{background:#000;color:#fff}
.trade-direction.short{background:#fff;color:#000}
.trade-direction.neutral{background:#f5f5f5;color:#525252;border-color:#e5e5e5}
.trade-title{font-family:'Playfair Display',serif;font-size:0.95rem;font-weight:600;margin-bottom:0.35rem;line-height:1.3}
.trade-rationale{font-size:0.82rem;color:#525252;line-height:1.55}
...
function renderBrief(b){
  ...
  // Sections
  const sectionIcons={FX:'FX',RATES:'RT',EQUITY:'EQ',COMMODITIES:'CM',MACRO:'MX','STRUCTURED PRODUCTS':'SP','KEY RISKS':'KR'};
